...
public class FeedItemAnimator extends DefaultItemAnimator {
    ...
    final Map<RecyclerView.ViewHolder, AnimatorSet> likeAnimationsMap = new HashMap<>();
    final Map<RecyclerView.ViewHolder, AnimatorSet> heartAnimationsMap = new HashMap<>();
